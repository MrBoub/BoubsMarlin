...
#define STRING_SPLASH_LINE1 "Boublin 2.3" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "FUCKING LEVELING"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Burp V2.0"
 ...
 */
  ...
  #define PROBE_PT_1_X 13
  #define PROBE_PT_1_Y -1
  #define PROBE_PT_2_X 221
  #define PROBE_PT_2_Y -1
  #define PROBE_PT_3_X 13
  #define PROBE_PT_3_Y 191
#endif
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 95                    // Y point for Z homing when homing all axes (G28).
#endif
